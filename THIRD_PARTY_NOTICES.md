...
| UnityPy | MIT | Unity AssetBundle解析 |
| pyfmodex | MIT | Unity AudioClip変換用バインディング |
| FMOD runtime library | FMOD End User License | UnityPy配布物に含まれるAudioClipデコード用ランタイム。FMODはFirelight Technologies Pty Ltd.の製品です |
...
FMOD attribution: FMOD © Firelight Technologies Pty Ltd.
